...
\caption{Term co-occurrence network, in which (a) shows the complete topology and (b) highlights communities.}
\par{\footnotesize\textit{Note.} Colors indicate communities, interpreted as groups of terms that co-occur more frequently with each other than with the rest of the network. Node size represents degree, that is the number of connections of each term. Edge thickness represents weight, that is the co-occurrence frequency between term pairs.}\par
\label{fig:network_topology}
\end{figure}

Essa transição é corroborada pela frequ\^encia de palavras-chave, na qual "Remote Sensing" (98), "Shifting Cultivation" (49), "Deforestation" (31), "Land Use" (24), "Landsat" (22), "Deep Learning" (20), "Machine Learning" (18), "Land Use Change" (17), "GIS" (15) e "Artificial Intelligence" (13) se destacam, sugerindo concomitantemente a centralidade do sensoriamento remoto como ferramenta e a consolida\c{c}\~ao do aprendizado profundo como abordagem anal\'itica predominante.
...
\caption{Cross-category co-occurrence views of the SAT corpus, in which (a) shows the algorithm-by-product subnetwork and (b) summarizes centrality metrics for the top nodes.}
