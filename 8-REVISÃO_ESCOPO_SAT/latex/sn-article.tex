...
Sistemas Agrícolas Tradicionais (SAT) podem ser modelados como sistemas socioecológicos nos quais práticas de manejo, diversidade biocultural e condições biofísicas coevoluem em horizontes temporais longos, sustentando paisagens culturais e serviços ecossistêmicos sob pressões crescentes no Antropoceno \citep{Berkes2003}. Em escala global, os SAT são formalmente reconhecidos por arcabouços institucionais como o programa Sistemas Importantes do Patrimônio Agrícola Mundial (GIAHS) da FAO, que já designou mais de 80 sítios em 24 países \citep{Koohafkan2011}, e a Plataforma Intergovernamental sobre Biodiversidade e Serviços Ecossistêmicos (IPBES), que identifica o conhecimento indígena e local como indispensável para a avaliação da biodiversidade \citep{IPBES2019}. [GAP MODIFICADO: Esses sistemas sustentam diretamente múltiplos Objetivos de Desenvolvimento Sustentável, notadamente o ODS~2 considerando fome zero, meta~2.4 sobre sistemas de produção alimentar sustentáveis, o ODS~13 sobre Ação Climática e o ODS~15 Vida Terrestre, meta~15.4 sobre conservação de ecossistemas de montanha \citep{UN2015}. Apesar dessa relevância política global, o monitoramento baseado em evidências da integridade dos SAT em escala de paisagem permanece fragmentado entre regiões e disciplinas. ]
...
Foram considerados elegíveis apenas artigos publicados em periódicos indexados nas bases consultadas, desde que recuperados pelas strings dentro do intervalo temporal e com metadados suficientes para charting, incluindo ao menos título e resumo. Não se aplicou restrição explícita de idioma na etapa de busca. A estratégia combinou termos em inglês com descritores suplementares em português (e.g., \textit{sistemas agrícolas tradicionais}, \textit{agricultura tradicional}) para maximizar a sensibilidade à literatura lusófona indexada em ambas as bases; embora termos equivalentes em espanhol, francês e outros idiomas não tenham sido incluídos, essa limitação é parcialmente mitigada pela predominância de resumos em inglês na Scopus e Web of Science e é explicitamente reconhecida na seção de Limitações. A delimitação do universo de evidências foi dada pela indexação em Scopus e Web of Science, o que implica exclusão de literatura cinzenta e de repositórios não indexados, opção adotada para maximizar rastreabilidade, padronização de metadados e reprodutibilidade do pipeline analítico.
...
Os achados desta revisão possuem implicações que extrapolam o refinamento metodológico, alcançando a agenda mais ampla da ciência da sustentabilidade. Os Sistemas Agrícolas Tradicionais, formalmente reconhecidos pelo programa FAO-GIAHS em 24 países e integrados às avaliações da IPBES sobre conhecimento indígena e local \citep{Koohafkan2011,IPBES2019}, representam interfaces críticas entre natureza e sociedade humana, onde lacunas de monitoramento se traduzem diretamente em déficits de governança.

A conformidade FAIR criticamente baixa (18,7/100) documentada neste estudo compromete a gestão baseada em evidências prevista pela meta~2.4 do ODS (sistemas de produção alimentar sustentáveis que mantenham ecossistemas) e pela meta~15.4 do ODS (conservação de ecossistemas de montanha e sua biodiversidade) \citep{UN2015}. Sem pipelines de ML reprodutíveis e auditáveis, a tradução de produtos de sensoriamento remoto em indicadores acionáveis para a gestão de sítios patrimoniais permanece aspiracional em vez de operacional. Essa lacuna é particularmente consequente para comunidades de pequenos agricultores no Sul Global, onde os SAT sustentam tanto meios de subsistência quanto agrobiodiversidade, mas onde a infraestrutura de dados é mais frágil \citep{Kshetri2014DigitalDivide}.

Além disso, a desigualdade geográfica revelada pela topologia de rede e pela MCA---onde a intensidade de pesquisa se concentra em regiões específicas enquanto a validação em contextos de SAT na África e Ásia Central permanece escassa---levanta preocupações sobre justiça epistêmica na governança algorítmica \citep{Santos2007Epistemologies}. Modelos treinados predominantemente em ambientes ricos em dados correm o risco de codificar vieses que são invisíveis quando implantados em paisagens sub-representadas, potencialmente marginalizando as próprias comunidades que as políticas de SAT pretendem proteger \citep{Tuia2021}. Enfrentar essa assimetria requer esforços coordenados para construir infraestruturas de dados abertas e interoperáveis que superem a exclusão digital \citep{Kshetri2014DigitalDivide} e incorporem validação participativa com detentores de conhecimento local, fortalecendo assim tanto os sistemas naturais quanto os sociais que sustentam a resiliência territorial \citep{Berkes2003,Altieri2004}.

Da perspectiva da interface ciência-política, a transição de classificadores estáticos para sistemas de suporte à decisão adaptativos e explicáveis deve ser acompanhada por mecanismos de governança que assegurem transparência algorítmica, consentimento comunitário e transferibilidade inter-regional. Somente por meio dessa integração o ML poderá cumprir seu potencial como ferramenta para salvaguardar a integridade socioecológica acoplada dos SAT sob aceleração das mudanças globais.
...
Diferentemente de revisões anteriores que apontavam fragmentação metodológica, os dados atuais indicam uma convergência tecnológica em torno de soluções híbridas e explicáveis. O exame dos 18 estudos de Alta aderência sugere que parte da fronteira do conhecimento tem avançado além da simples classificação de cobertura do solo, aproximando-se de gêmeos digitais com potencial de inferir fitopatologias, dinâmica de carbono e mobilidade humana em condições operacionais reportadas. Contudo, a transposição dessas evidências para decisões de salvaguarda que atendam arcabouços globais de sustentabilidade---incluindo a gestão de sítios patrimoniais FAO-GIAHS e as metas~2.4 e 15.4 dos ODS---enfrenta o desafio da robustez externa, pois modelos carecem de validação inter-regional sistemática nos diversos contextos biofísicos e culturais onde os SAT operam mundialmente.

Em suma, a aplicabilidade operacional de ML em contextos de SAT não se limita à acurácia algorítmica, que pode atingir níveis elevados, mas também envolve a construção de infraestruturas de dados FAIR, a adoção de protocolos de validação espacial e temporal rigorosos e a incorporação de mecanismos de governança participativa que assegurem transparência algorítmica e inclusividade epistêmica entre regiões. O futuro da pesquisa em SAT tende a convergir para a transição de classificadores estáticos para sistemas adaptativos, auditáveis e globalmente transferíveis, com potencial para converter terabytes de dados orbitais em evidências verificáveis para a gestão sustentável de paisagens de patrimônio agrícola em escala mundial.
