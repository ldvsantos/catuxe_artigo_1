...
Essa transição é corroborada pela frequência de palavras-chave (Tabela \ref{tab:keywords}), onde "Remote Sensing" e "Deep Learning" emergem como termos dominantes, indicando a ferramenta preferencial e a abordagem analítica predominante, respectivamente.

\begin{table}[h]
\centering
\caption{Principais palavras-chave associadas aos estudos de ML e SAT (Top 10)}
\label{tab:keywords}
\begin{tabular}{@{}lc@{}}
\toprule
