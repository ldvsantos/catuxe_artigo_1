...
\title{\textbf{Prontidão do aprendizado de máquina para suporte à transição agroecológica em sistemas agrícolas tradicionais}}
...
\author[1]{\fnm{Alceu} \sur{Pedrotti}}
...
\affil[3]{\orgname{Universidade Federal Rural de Pernambuco - UFRPE}, \orgaddress{\country{Brasil}}}

\abstract{Sistemas Agrícolas Tradicionais constituem sistemas socioecológicos acoplados cuja integridade demanda monitoramento baseado em evidências, porém a prontidão operacional do aprendizado de máquina para essa finalidade permanece incerta. O objetivo desta meta-análise é avaliar em que medida deficiências em governança de dados e validação espacial limitam a aplicabilidade regulatória dos modelos de aprendizado de máquina aplicados a esses sistemas, apesar da elevada acurácia reportada. Esta meta-análise examinou 244 estudos (2010--2025) recuperados de Scopus e Web of Science mediante diretrizes padronizadas para revisões de escopo, aplicando pontuação automatizada de relevância (precisão 94,2\%) com validação manual (coeficiente de correlação intraclasse = 0,87), modelo de efeitos aleatórios, análise de redes (modularidade Q = 0,62) e avaliação de conformidade com os princípios de dados localizáveis, acessíveis, interoperáveis e reutilizáveis. Aqui demonstramos que a acurácia combinada atinge 90,7\% (intervalo de confiança de 95\% entre 89,8 e 91,5\%) com heterogeneidade substancial ($I^{2}$ = 58\%), enquanto a adoção de aprendizado profundo aumentou de 4,8\% (2015--2019) para 21,1\% (2020--2025). Entretanto, a conformidade com esses princípios permaneceu criticamente baixa (escore médio 18,7/100), com apenas 1,1\% dos estudos compartilhando código ou dados, e a análise de viés de publicação (teste de Egger, p = 0,009) sugere superestimação de desempenho em aproximadamente 1,5 pontos percentuais. Lacunas críticas em protocolos de validação espacial, explicabilidade algorítmica e infraestrutura de governança de dados limitam a prontidão operacional para aplicações regulatórias em contextos de Sistemas Agrícolas Tradicionais, com implicações diretas para o monitoramento de sítios patrimoniais do programa Sistemas Importantes do Patrimônio Agrícola Mundial e as metas 2.4 e 15.4 dos Objetivos de Desenvolvimento Sustentável, evidenciando a necessidade de validação inter-regional e governança algorítmica transparente para apoiar a gestão baseada em evidências da agrobiodiversidade.}

\keywords{deep learning, aprendizado de máquina, meta-análise, governança de dados, FAIR}

\maketitle

\section[Introdução]{Introdução}

Sistemas Agrícolas Tradicionais podem ser modelados como sistemas socioecológicos nos quais práticas de manejo, diversidade biocultural e condições biofísicas coevoluem em horizontes temporais longos, sustentando paisagens culturais e serviços ecossistêmicos sob pressões crescentes no Antropoceno \citep{Berkes2003}. Em escala global, esses sistemas são formalmente reconhecidos por arcabouços institucionais como o programa Sistemas Importantes do Patrimônio Agrícola Mundial da Organização das Nações Unidas para Alimentação e Agricultura, que já designou mais de 80 sítios em 24 países \citep{Koohafkan2011}, e a Plataforma Intergovernamental sobre Biodiversidade e Serviços Ecossistêmicos, que identifica o conhecimento indígena e local como indispensável para a avaliação da biodiversidade \citep{IPBES2019}.

Esses sistemas sustentam diretamente múltiplos Objetivos de Desenvolvimento Sustentável, em particular o Objetivo~2 (Fome Zero), a meta~2.4 sobre sistemas de produção alimentar sustentáveis, o Objetivo~13 (Ação Climática) e o Objetivo~15 (Vida Terrestre) \citep{UN2015}. Apesar dessa relevância política global, o monitoramento baseado em evidências da integridade dos sistemas tradicionais em escala de paisagem permanece fragmentado entre regiões e disciplinas. A heterogeneidade espacial, a complexidade sistêmica e a provisão distribuída de serviços ecossistêmicos geram desafios de mensuração e monitoramento que podem ser parcialmente mitigados por abordagens de aprendizado de máquina integradas a dados de sensoriamento remoto \citep{Weiss2020,Osco2021}. 

No entanto, a prontidão operacional dessas tecnologias para suporte à transição agroecológica em contextos tradicionais permanece incerta, especialmente diante de lacunas em governança de dados e validação espacial que podem comprometer a aplicabilidade regulatória e a prestação de contas baseada em evidências. Essa complexidade aparece em tipologias diversas de Sistemas Agrícolas Tradicionais, desde terraços irrigados e sistemas agroflorestais estratificados, quintais produtivos agroecológicos (Figura \ref{fig:photo_intro}) até sistemas agropecuários de fundo de pasto \citep{Koohafkan2011,Altieri2004}, nos quais a sobreposição espacial de estratos arbóreos, cultivos alimentares, criação animal e remanescentes de vegetação nativa forma mosaicos de uso do solo cujo acoplamento socioecológico desafia abordagens de monitoramento convencionais.

\begin{figure}[ht]
\centering
\includegraphics[width=0.85\textwidth]{../2-FIGURAS/1-PT/sat.jpg}
\caption{Quintais produtivos agroecológicos em Sistema Agrícola Tradicional (Photocredit: Catuxe Oliveira).}
\label{fig:photo_intro}
\end{figure}

Ao serem compreendidos como territórios socioecológicos intrinsecamente acoplados, nos quais solo, clima, biota, cultura e instituições interagem por dinâmicas não lineares e heterogeneidades espaço-temporais, esses sistemas produzem simultaneamente alimentos, serviços ecossistêmicos e valores bioculturais cuja mensuração depende de escolhas metodológicas, qualidade de dados e coerência operacional entre indicadores \citep{LeFloc2016S}. 
...
Nesse contexto, o aprendizado de máquina emerge como ferramenta promissora para operacionalizar sistemas de monitoramento e suporte à decisão baseados em evidências, integrando dados de sensoriamento remoto, variáveis edafoclimáticas e indicadores socioecológicos \citep{Mountrakis2011,Spyrou2025}. A robustez operacional desses sistemas beneficia-se de validação espacialmente independente e estabilidade longitudinal frente à variabilidade climática \citep{Kuhn2013}, além de métodos de inteligência artificial explicável que possibilitem interpretar marcadores biofísicos relevantes \citep{Rudin2019}. A adesão aos princípios FAIR (Findable, Accessible, Interoperable, Reusable) sustenta a reprodutibilidade e rastreabilidade das análises \citep{Wilkinson2016}.

Diante desse diagnóstico, esta revisão de escopo avalia a maturidade técnica do aprendizado de máquina aplicado a Sistemas Agrícolas Tradicionais, investigando simultaneamente o desempenho preditivo reportado por diferentes famílias algorítmicas e domínios de aplicação (cobertura do solo, propriedades edáficas, produção), a extensão com que os estudos implementam estratégias de validação espacial capazes de sustentar generalizabilidade inter-regional, o nível de conformidade com princípios FAIR no compartilhamento de dados e código, e os clusters temáticos e trajetórias tecnológicas que estruturam a evolução do campo entre 2010 e 2025.
...
Foram considerados elegíveis apenas artigos publicados em periódicos indexados nas bases consultadas, desde que recuperados pelas strings dentro do intervalo temporal e com metadados suficientes para charting, incluindo ao menos título e resumo. Não se aplicou restrição explícita de idioma na etapa de busca; a estratégia empregou exclusivamente termos em inglês, idioma dominante na indexação da Scopus e Web of Science, assegurando comparabilidade com revisões sistemáticas internacionais e eliminando ambiguíades de cobertura associadas a descritores multilinguîs. A delimitação do universo de evidências pela indexação nessas duas bases implica exclusão de literatura cinzenta e de repositórios não indexados, opção adotada para maximizar rastreabilidade, padronização de metadados e reprodutibilidade do pipeline analítico.
...
\end{equation}
onde $w_i = 1/(\sigma_i^2 + \tau^2)$ e $\tau^2$ representa a variância entre estudos \citep{Viechtbauer2010}. A incerteza foi reportada como intervalo de confiança (IC) de 95\%. Assimetrias compatíveis com viés de publicação foram examinadas por regressão de Egger, correlação de postos e procedimento \textit{trim-and-fill}, com interpretação como diagnóstico de sensibilidade do reporte.
...
As associações entre categorias metodológicas, geográficas e temporais no corpus chartado foram exploradas por Análise de Correspondência Múltipla (MCA) em tabela categórica, usando as dimensões \textit{Algoritmo}, \textit{Evidência}, \textit{Contexto}, \textit{Aplicação} e \textit{Região}, com projeção em duas dimensões fatoriais para leitura da estrutura latente de coassociações.
...
No eixo de governança de dados, quantificou-se conformidade FAIR por score padronizado (0 a 100 pontos) baseado em 12 indicadores binários \citep{Wilkinson2016}. Os indicadores foram codificados por sinais textuais presentes nos metadados e no reporte (p.ex., DOI, presença de repositório de dados, disponibilidade de código, licença explícita, documentação), com contribuição uniforme ($100/12 \approx 8{,}33$ pontos por indicador) e agregação nas quatro dimensões FAIR por média aritmética.
...
Ao examinar as tendências tecnológicas de forma decomposta (Fig. \ref{fig:temporal_combined}b), qualifica-se esse crescimento quantitativo e observa-se um ponto de inflexão metodológica situado no triênio 2018--2020. Enquanto a fase inicial foi sustentada por classificadores de aprendizado de máquina convencionais, especialmente \textit{Random Forest} e SVM \citep{Belgiu2016,Mountrakis2011}, cuja eficácia em dados espectrais de média resolução contribuiu para a predominância inicial, o período recente (2020--2025) é marcado por crescente adoção de arquiteturas de \textit{deep learning} \citep{Osco2021,Weiss2020}. 
...
Identificou-se na triagem um núcleo de estudos de Alta aderência (Score $\geq$ 12), com 18 trabalhos distribuídos entre 2010 e 2025 e predominantemente indexados na Scopus (17/18), consistentes com a fronteira recente de integração entre inteligência computacional e sistemas tradicionais. Destaca-se o trabalho de \cite{Li2025}, que propõe sistemas unificados de AIoT para controle de pragas, e a pesquisa de \cite{Tripathi2025}, que desenvolve arquiteturas híbridas de \textit{deep learning} para diagnóstico fitopatológico.

O resumo dos principais estudos de alta relevância (Tabela \ref{tab:top7}) ilustra a diversidade geográfica e temática das aplicações, abrangendo contextos tropicais, subtropicais e de terras secas em múltiplos continentes.

\begin{table}[h]
\caption{Estudos de Alta aderência em aprendizado de máquina aplicado a sistemas agrícolas tradicionais (2024-2025)}
\label{tab:top7}
\centering
\small
...
Ao aprofundar a análise estrutural, a detecção de comunidades (Figura \ref{fig:network_communities}) sugere clusters temáticos bem definidos. A metrificação de centralidade aponta a co-prominência dos clusters \textit{Americas}, \textit{Asia} e \textit{Global}, refletindo a aplicação geograficamente distribuída, porém desigual, de geotecnologias em paisagens agrícolas tradicionais em escala mundial. Esses clusters regionais estão fortemente acoplados a nós tecnológicos como \texttt{NeuralNetwork} e \texttt{DeepLearning}, evidenciando uma convergência global em direção a abordagens computacionais avançadas, apesar das disparidades regionais em disponibilidade de dados e infraestrutura de validação.

Esta configuração sugere uma transição metodológica onde, diferentemente da primeira década (2010--2020) focada na validação de sensores espectrais (NIR/FTIR), o período recente (2021--2025) é marcado por maior adoção de arquiteturas de aprendizado profundo aplicadas à fusão de dados multi-sensores \citep{Liakos2018,Weiss2020,Osco2021}.
...
Coerentemente, a estrutura multivariada da MCA evidencia a reorganização temática e geográfica do ecossistema de pesquisa ao longo da janela 2010--2025 (Figura \ref{fig:mca_temporal}), com 186 observações categorizadas e um gradiente temporal que reconfigura simultaneamente algoritmos, contextos e aplicações. No período 2010--2014, predominou o contexto de agricultura itinerante (26/30) e a aplicação em mapeamento de uso e cobertura do solo (24/30, 80\%), com baixa diversidade algorítmica registrada na codificação (27/30 em \textit{Other}). 

Em contrapartida, entre 2020 e 2025, ampliou-se a participação de contextos SAT-General (63/114, 55,3\%) concomitantemente à diversificação de aplicações, com uso e cobertura do solo reduzido a 35/114 (30,7\%) e aumento de usos em solo (16/114, 14\%), monitoramento (10/114, 8,8\%) e produtividade (9/114, 7,9\%). Em paralelo, a categoria \textit{DeepLearning} elevou-se de 2/42 (4,8\%) em 2015--2019 para 24/114 (21,1\%) em 2020--2025, com distribuição regional mais explicitamente mapeada para Ásia (35/114) e um bloco Global (50/114), sustentando a leitura de maturidade operacional por duas dimensões complementares, a governança de dados e o desempenho reportado.

\subsection[Estrutura de clusters funcionais]{Estrutura de clusters funcionais}

Dois grupos funcionais coesos ($k=2$, silhueta=0,215), diferenciados por perfis metodológicos dominantes, emergiram da análise hierárquica de clusters (Figura \ref{fig:cluster_heatmap}). O Cluster 1 (n=70, 37,8\%) caracteriza-se por forte associação com \textit{Contexto=SAT-General} (0,986) e \textit{Algoritmo=DeepLearning} (0,30), representando estudos de aplicação de técnicas computacionais avançadas em sistemas agrícolas tradicionais generalizados, com presença marcante na Ásia (0,414) e escala global (0,343). Este cluster demonstra uma correlação estatística significativa entre abordagens de \textit{deep learning} e contextos agrícolas diversificados ($\rho=0,78$, p$<$0,001), sugerindo que a complexidade algorítmica responde à necessidade de modelar interações socioecológicas não-lineares em paisagens heterogêneas. A distribuição geográfica concentrada na Ásia (41,4\%) e em estudos globais (34,3\%) corrobora a hipótese de que a adoção de técnicas avançadas está associada a regiões com maior disponibilidade de dados de sensoriamento remoto de alta resolução.

O Cluster 2 (n=115, 62,2\%) concentra aplicações de \textit{Contexto=Swidden} (0,887) e \textit{Aplicacao=LULC} (0,713), refletindo a dominância histórica de estudos de mapeamento de cobertura do solo em agricultura itinerante, com métodos diversos (\textit{Algoritmo=Other}, 0,809) e evidências híbridas (0,383). Este agrupamento exibe uma assimetria metodológica onde 80,9\% dos estudos empregam algoritmos convencionais, contrastando com apenas 7,8\% de aplicações de \textit{deep learning}. A análise de distâncias euclidianas no espaço fatorial (MCA) revela que este cluster ocupa uma posição ortogonal ao Cluster 1 (ângulo de 87°), indicando perfis funcionais complementares mas não sobrepostos.

O dendrograma evidencia a organização hierárquica das características, onde ramos agregando múltiplos estudos foram anotados com labels compactos indicando a dimensão dominante (e.g., \textit{Alg/Other}, \textit{Ctx/SATGen}). A estrutura sugere que a coocorrência de categorias não é aleatória, mas estruturada por afinidades tecnológicas, \textit{DeepLearning} em contextos SAT-General e temáticas como \textit{LULC} em agricultura itinerante, sustentando a hipótese de módulos temáticos especializados no campo científico analisado. A altura de corte ótima (0,62) no dendrograma confirma a robustez da bipartição, com coeficiente de cophenético de 0,89, validando a fidelidade da representação hierárquica.
...
A dinâmica evolutiva da produção científica (Figura \ref{fig:temporal_combined}a) indica uma transição de aplicações exploratórias de suporte à decisão para arquiteturas de inferência mais robustas em sistemas agrícolas tradicionais. Essa inflexão é refletida pela substituição progressiva de vetores de suporte e florestas aleatórias por redes neurais profundas (Figura \ref{fig:temporal_combined}b), consistênte com a necessidade de capturar dinâmicas biofísicas não lineares por meio de arquiteturas computacionais mais flexíveis \citep{Weiss2020}. 

A saturação de desempenho observada nos classificadores discretos sugere que a modelagem da complexidade socioecológica pode beneficiar-se de abordagens baseadas em lógica difusa, onde a pertinência a classes de uso do solo não é binária, mas contínua, permitindo modelar a ambiguidade das zonas de transição típicas de agricultura itinerante e quintais agroflorestais, conforme discutido por \citep{Foody2020}, \citep{Osco2021} e \citep{Denis20151499}.

A topologia da rede de coocorrência (Figura \ref{fig:network_communities}) indica compartimentação temática relevante para o desenvolvimento de sistemas de suporte à decisão. A existência de módulos segregados, sendo um ancorado em resoluções espectrais médias e outro em sensores de altíssima resolução, sustenta a hipótese de que a assinatura ótica dos serviços ecossistêmicos é dependente de escala, limitando a generalização de gêmeos digitais para múltiplos regimes observacionais e contextos territoriais \citep{Basso2020,Jones2020DigitalTwin,VanDerHorn2021DigitalTwin}. Essa fragmentação indica que a robustez depende da calibração de funções de pertinência específicas para cada regime de resolução, reduzindo erros de modelagem por incompatibilidade dimensional.
...
A ortogonalidade entre as aplicações de monitoramento de carbono (Cluster 1, Figura \ref{fig:cluster_heatmap}) e o mapeamento de práticas de corte-e-queima (Cluster 2, Figura \ref{fig:cluster_heatmap}) sugere mecanismos causais distintos, enquanto a dinâmica de carbono responde a variáveis biofísicas contínuas bem capturadas por \textit{deep learning} \citep{Celette2016WaterStress}, o delineamento de distúrbios pirogênicos é regido por topologias discretas. Para um sistema de suporte à decisão auditável, isso pode requerer arquiteturas híbridas, capazes de integrar inferência difusa para variáveis de estado contínuas e lógica booleana para detecção de eventos discretos \citep{Akram2026}.

No tocante à integridade da cadeia de custódia de dados, a baixa conformidade com os princípios FAIR (Figura \ref{fig:fair_radar}) gera opacidade epistêmica incompatível com a transparência requerida para auditoria territorial e para o suporte a decisões de transição agroecológica, uma vez que a ausência de metadados de proveniência e scripts de treinamento dificulta a verificação independente da estabilidade dos modelos, comprometendo a confiabilidade de qualquer indicador derivado \citep{Tuia2021,Samuel2021,Ivie2018,Zheng2024}. Sob uma perspectiva de engenharia de sistemas orientada à governança, a auditabilidade algorítmica pode ser tão relevante quanto a precisão estatística \citep{Rudin2019}. Sem rastreabilidade, a inferência permanece como estimativa não verificável, com valor limitado para a certificação de serviços ecossistêmicos e, por extensão, para o desenho e a avaliação de inovações em sistemas agrícolas nos termos exigidos por arcabouços de transição sociotécnica \citep{Tuia2021}.
...
Na ótica de sistemas difusos, essa instabilidade reflete a tentativa fracassada de forçar categorias nítidas como região florestal e áreas rurais sobre um contínuo ecológico complexo \citep{Fisher2010}. O desempenho superior nominal de arquiteturas profundas não elimina a incerteza epistêmica \citep{Hullermeier2021}, o que tende a encapsulá-la em representações latentes de difícil interpretação \citep{Tuia2021}. Portanto, a próxima geração de ferramentas de auditoria pode necessitar priorizar a explicabilidade algorítmica e a modelagem explícita da incerteza (intervalos de confiança, conjuntos difusos) em detrimento da maximização de métricas de acurácia pontual \citep{Rudin2019,Ghilardi2025}.

\subsection[Implicações para a governança global de sustentabilidade]{Implicações para a governança global de sustentabilidade}

Transposta para a escala de governança global, a convergência entre opacidade de dados, viés de reporte e compartimentação epistêmica discutidos nas seções precedentes limita a operacionalização de sistemas de suporte à decisão para monitoramento e transição agroecológica de sistemas agrícolas tradicionais \citep{Wezel2009} no âmbito da Agenda 2030, particularmente nas metas dos Objetivos de Desenvolvimento Sustentável~2 (Fome Zero) e 15 (Vida Terrestre) \citep{UN2015}. Reconhecidos pelo programa Sistemas Importantes do Patrimônio Agrícola Mundial em 24 países e integrados às avaliações da Plataforma Intergovernamental sobre Biodiversidade e Serviços Ecossistêmicos sobre conhecimento indígena e local \citep{Koohafkan2011,IPBES2019}, esses sistemas constituem interfaces de acoplamento natureza-sociedade nas quais déficits de monitoramento comprometem diretamente o desenho e a implementação de inovações em sistemas agrícolas, com consequências que extrapolam o âmbito metodológico.

Quantitativamente, o colapso nas dimensões de acessibilidade (0,65\%) e interoperabilidade (0,22\%) que compõem a pontuação FAIR agregada de 18,67/100 (Fig.~\ref{fig:fair_radar}) estabelece a magnitude operacional dessa limitação: sem \textit{pipelines} de aprendizado de máquina reprodutíveis e auditáveis, a conversão de produtos de sensoriamento remoto em indicadores acionáveis para gestão de sítios patrimoniais permanece inviável nos termos exigidos pelas metas~2.4 e 15.4 dos Objetivos de Desenvolvimento Sustentável \citep{UN2015,Mottet2020TAPE}, que pressupõem sistemas de monitoramento verificáveis como condição de conformidade regulatória. Essa fragilidade é sistematicamente agravada para comunidades do Sul Global, onde os sistemas tradicionais sustentam simultaneamente meios de subsistência e agrobiodiversidade, mas onde a infraestrutura de dados abertos apresenta menor densidade e cobertura \citep{Kshetri2014DigitalDivide}.

Paralelamente, a desigualdade geográfica evidenciada pela topologia de rede (Fig.~\ref{fig:network_communities}) e consolidada pela estrutura fatorial da Análise de Correspondência Múltipla (Fig.~\ref{fig:mca_temporal}) introduz um risco adicional de viés de codificação algorítmica com implicações diretas para a validade externa dos modelos. Conforme documentado no Cluster~1 (Ásia 41,4\%; escala global 34,3\%), a sub-representação sistemática de sistemas agrícolas tradicionais na África e Ásia Central implica que padrões espectrais e fenológicos codificados em ambientes ricos em dados não são generalizáveis, ampliando erros de classificação quando implantados em paisagens sub-representadas \citep{Santos2007Epistemologies,Tuia2021}. Superar essa assimetria pode requerer infraestruturas de dados interoperáveis que reduzam barreiras de exclusão digital \citep{Kshetri2014DigitalDivide} e incorporem protocolos de validação participativa com detentores de conhecimento local, condição que parece necessária à robustez externa dos modelos em contextos regulatórios e de gestão patrimonial \citep{Berkes2003,Altieri2004}.

Em síntese, na interface ciência-política, a transição de classificadores estáticos para sistemas de suporte à decisão adaptativos e explicáveis pode requerer mecanismos de governança que assegurem rastreabilidade algorítmica, consentimento comunitário e transferibilidade inter-regional comprovada, condições sem as quais a capacidade preditiva de um modelo não se converte em instrumento de gestão auditável. Essa integração técnica e institucional parece necessária para que o aprendizado de máquina opere como ferramenta de monitoramento e avaliação com valor regulatório para a salvaguarda da integridade socioecológica dos sistemas agrícolas tradicionais sob aceleração das mudanças globais.

\subsection[Limitações]{Limitações}

Quanto às limitações, o intercepto de Egger ($\beta_0 = 1{,}87$; $p = 0{,}009$) e a correção \textit{trim-and-fill} ($-$1,54 p.p.) classificam a acurácia combinada de 90,66\% como limite superior do desempenho \textit{reportado}, não como benchmark operacional. A análise de sensibilidade excluindo os 37,2\% dos estudos com n imputado confirmou estabilidade da estimativa (89,8\% vs. 90,7\%), indicando que a imputação não introduziu desvio material. A ausência de instrumentos formais de avaliação de viés em nível de estudo (PROBAST, QUADAS-2) impede estratificação por qualidade metodológica, enquanto a restrição a termos em inglês nas bases Scopus e Web of Science pode sub-representar iniciativas de monitoramento em regiões não anglofônicas. Por fim, estratégias de validação espacial não foram sistematicamente extraídas, limitando a quantificação empírica da degradação de desempenho em validade externa. Em conjunto, os achados proveem um referencial diagnóstico do estado atual, não benchmarks prontos para implantação regulatória.

\section[Conclusões]{Conclusões}

Esta pesquisa sistematiza a compreensão de Sistemas Agrícolas Tradicionais como sistemas socioecológicos acoplados, cuja tipicidade emerge de interações não lineares entre variáveis edafoclimáticas e práticas culturais. Os resultados são consistentes com a emergência de um paradigma de monitoramento digital em franca expansão no período analisado (2010--2025), ancorado na integração de sensores remotos e arquiteturas de aprendizado profundo (\textit{deep learning}). A topologia da rede de conhecimento, com densidade de 0,3455, revela um ecossistema de pesquisa coeso, porém geograficamente desigual, onde a concentração de estudos em regiões específicas coexiste com lacunas críticas de validação em contextos de sistemas tradicionais na África, Ásia Central e Pacífico.

O exame dos 18 estudos de Alta aderência sugere que parte da fronteira do conhecimento tem avançado além da simples classificação de cobertura do solo, aproximando-se de gêmeos digitais com potencial de inferir fitopatologias, dinâmica de carbono e mobilidade humana em condições operacionais reportadas. Contudo, a transposição dessas evidências para decisões de salvaguarda que atendam arcabouços globais de sustentabilidade, incluindo a gestão de sítios patrimoniais do programa Sistemas Importantes do Patrimônio Agrícola Mundial e as metas~2.4 e 15.4 dos Objetivos de Desenvolvimento Sustentável, enfrenta o desafio da robustez externa, pois modelos carecem de validação inter-regional sistemática nos diversos contextos biofísicos e culturais onde esses sistemas operam mundialmente.

Em suma, a aplicabilidade operacional do aprendizado de máquina em contextos de sistemas agrícolas tradicionais não se limita à acurácia algorítmica, mas depende de infraestruturas de dados em conformidade com os princípios FAIR, protocolos rigorosos de validação espacial e temporal e mecanismos de governança participativa que assegurem transparência algorítmica e inclusividade epistêmica entre regiões. Pesquisas futuras podem consolidar a transição de classificadores estáticos para sistemas adaptativos, auditáveis e globalmente transferíveis, com potencial para converter terabytes de dados orbitais em evidências verificáveis para a gestão sustentável de paisagens de patrimônio agrícola em escala mundial.
...
Os autores não receberam financiamento de nenhuma organização para o trabalho submetido. Nenhum recurso, bolsa ou outro suporte foi recebido.

\subsection*{Conflicts of interest}

Os autores declaram não possuir interesses financeiros ou não financeiros relevantes a divulgar.

\subsection*{Ethics approval}

Not applicable. Este estudo baseia-se exclusivamente em dados secundários publicados e não envolveu participantes humanos, dados pessoais ou material biológico.
...
O conjunto completo de dados que sustenta este estudo, incluindo o corpus bibliográfico, os scripts de análise e os resultados intermediários, está publicamente disponível no Open Science Framework (OSF) sob DOI \url{https://doi.org/10.17605/OSF.IO/J7STC}.

\subsection*{Disponibilidade de código}

Todos os scripts de análise (Python e R) usados na triagem automatizada, na meta-análise, na análise de redes, na análise de correspondência múltipla e na avaliação de conformidade FAIR estão publicamente disponíveis no Open Science Framework (OSF) sob DOI \url{https://doi.org/10.17605/OSF.IO/J7STC}.

\subsection*{Contribuições dos autores}

Conceptualization, L.D.V.S. and C.V.S.O.; Methodology, L.D.V.S.; Software, L.D.V.S.; Formal analysis, L.D.V.S.; Investigation, C.V.S.O. and L.D.V.S.; Data Curation, L.D.V.S.; Writing -- original draft, L.D.V.S. and C.V.S.O.; Writing -- review \& editing, P.R.G., R.N.A.F., T.C.A., G.S.Q., A.P. and F.S.R.H.; Visualization, L.D.V.S.; Supervision, F.S.R.H. and P.R.G.; Project administration, C.V.S.O. All authors read and approved the final manuscript.

\bibliography{referencias}

\section*{Referências da meta-análise}

A lista completa dos 244 estudos incluídos nesta meta-análise é fornecida em documento suplementar separado (\textit{References of the Meta-Analysis}), disponível junto a este manuscrito e depositado no Open Science Framework (OSF) sob DOI \url{https://doi.org/10.17605/OSF.IO/J7STC}.
